...
* sexe_2018, age_2018, mstat_2018, educ_hi_2018, alfab_2018, educ_scol_2018
...
foreach v in employed unemployed in_labor_force working_age ///
    sector_work emp_type work_activity formal public_employer ///
...
foreach v in hhweight hhsize eqadu1 eqadu2 region dep_ratio ///
    logem mur toit sol ///
...
* sexe_2021, age_2021, mstat_2021, educ_hi_2021, alfab_2021, educ_scol_2021
...
* Household characteristics
foreach v in hhweight hhsize eqadu1 eqadu2 region month dep_ratio ///
    logem mur toit sol ///
    eauboi_ss eauboi_sp elec_ac elec_ur elec_ua ///
    ordure toilet eva_toi eva_eau ///
    tv fer frigo cuisin ordin decod car superf ///
...
*------------------------------------------------------------------------------
* 7.1b: GDP deflator-adjusted monthly income (real 2018 prices)
*------------------------------------------------------------------------------

foreach yr in 2018 2021 {
    gen monthly_income_real_`yr' = monthly_income_`yr' * (${gdpdef_2018} / ${gdpdef_`yr'}) ///
        if !missing(monthly_income_`yr')
    label variable monthly_income_real_`yr' "Monthly income in real 2018 prices (`yr')"
}
