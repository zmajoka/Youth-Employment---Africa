...
*profits, capital, and non-hh employees by location 

preserve 
replace profit_real_2018=0 if profit_real_2018<0 & profit_real_2018!=.
collapse profit_real_2018 value_total_real_2018 num_emp_2018 [pweight=hhweight_2018], by(location_2018)
outsheet using "$output\HHEs_outcomes_2018.xls", replace
restore


preserve
replace profit_real_2021=0 if profit_real_2021<0 & profit_real_2021!=.
collapse profit_real_2021 value_total_real_2021 num_emp_2021 [pweight=hhweight_2021], by(location_2021)
outsheet using "$output\HHEs_outcomes_2021.xls", replace
restore
